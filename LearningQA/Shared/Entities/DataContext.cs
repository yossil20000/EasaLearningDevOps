...
namespace LearningQA.Shared.Entities
{
	public  class DataContext : LearningQAContext
	{
		...
		public DataContext(IConfiguration configuration/*, IServiceCollection services*/, DbContextOptions<LearningQAContext> options) : base(configuration/*,services*/, options)
		{
		}
