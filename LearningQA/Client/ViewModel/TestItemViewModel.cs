...
namespace LearningQA.Client.ViewModel
{
	public interface ITestItemViewModel
	{
		...
		void OnFinishTest();
		void OnCheckTest();
		 Task<Response>  OnSaveCurrentExam();
	...
	public class TestItemViewModel : ITestItemViewModel
	{
		...
		public IPersonInfoPersist _personInfoPersist;
		public TestItemViewModel(ITestItemModel testItemModel, TestItemViewModelPersist testItemViewModelPersist, IPersonInfoPersist personInfoPersist)
		{
		...
		public async Task<Response> OnSaveCurrentExam()
		{
			var response =  await testItemModel.SaveTest(TestItemViewModelPersist.CurrentTest, _personInfoPersist.SelectedPerson.Id);
			if (response.IsSucced)
				TestItemViewModelPersist.ExamState = ExamState.ExamSaved;
			else
				TestItemViewModelPersist.ExamState = ExamState.ExamSaveFailed;
			return response;
		}
